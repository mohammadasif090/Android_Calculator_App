    ...
    */
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (!isPop) {
                trackAddedFragmentsInPop = record.expandOps(this.mTmpAddedFragments, oldPrimaryNav2);
            } else {
                trackAddedFragmentsInPop = record.trackAddedFragmentsInPop(this.mTmpAddedFragments, oldPrimaryNav2);
            }
            oldPrimaryNav2 = trackAddedFragmentsInPop;
