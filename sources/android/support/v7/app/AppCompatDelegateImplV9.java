    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            ...
            if (this.mOverlayActionMode) {
                viewGroup = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                viewGroup = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple, (ViewGroup) null);
            }
            subDecor = viewGroup;
